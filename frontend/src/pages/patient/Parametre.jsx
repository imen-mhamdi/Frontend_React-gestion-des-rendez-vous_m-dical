          ...
          <Row>
                ...
                <Card.Body>
                  <div className="e-profile">
                    <div className="text-center text-sm-right">
                      <Badge variant="secondary" style={{ width: '10%', marginLeft: '90%', fontWeight: 'bold' }}>Patient</Badge>
                    </div>
                    <Row>
                      ...
                      <Col className="d-flex flex-column flex-sm-row justify-content-between mb-3">
                        <div style={{ marginLeft: '40%' }}>
                          <div style={{ textAlign: 'center' }}>
                            <h4 className="pt-sm-2 pb-1 mb-0 text-nowrap">Iheb</h4>
                            <p className="mb-0">@Iheb.s</p>
                            <div className="mt-2">
                              ...
                              <Row>
                                <Col>
                                  <Form.Group>
                                    ...
                                    <Form.Control type="text" name="name" placeholder="John Smith" defaultValue="Iheb Zouaoui" />
                                  </Form.Group>
                                </Col>
                                <Col>
                                  <Form.Group>
                                    <Form.Label><b>Prénom</b></Form.Label>
                                    <Form.Control type="text" name="username" placeholder="johnny.s" defaultValue="iheb.s" />
                                  </Form.Group>
                                </Col>
                              </Row>
                              <Row>
            ...
            <Col xs={12} md={3} className="mb-3">
              <Card style={{ marginBottom: '10%' }}>
                <Card.Body>
                  <h6 className="card-title font-weight-bold" style={{ textAlign: 'center' }}>Support</h6>
                  <p className="card-text">Get fast, free help from our friendly assistants.</p>
                  <Button variant="primary" style={{ marginLeft: '25%' }}>Contact Us</Button>
                </Card.Body>
              </Card>
              <Card className="mb-3">
                <Card.Body>
                  <div className="px-xl-3">
                    <Button variant="secondary" block style={{ marginLeft: '25%' }}>
